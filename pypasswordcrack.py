...
try:
    ...
    with open(input_file,'r') as f:
        ...
        # for line in f.readlines():
            # words = line.strip()
            # Remove any white space from the beginning or end of the line
    ...
    # This will allow is to write the generated combinations to the file
...
# This will help us debut issues that may arise during execution
